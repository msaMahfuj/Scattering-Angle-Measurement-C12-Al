# CR-39 two-vector scattering pipeline (dot-product arccos)
# SINGLE-ENERGY VERSION (110 MeV/n) + FINAL SUMMARY TABLE + THEORY PLOT
...
with PdfPages(
    ...
    peak_dxA, peak_dyA, sigA, dxA_full, dyA_full = (
        kd_alignment_sample(
            dfA_f,
            dfA_b,
            tag_A,
    ...
    peak_dxB, peak_dyB, sigB, dxB_full, dyB_full = (
        kd_alignment_sample(
            dfB_f,
            dfB_b,
            tag_B,
    ...
    # ========================================================
    #
    # STYLE MATCHES YOUR ATTACHED IMAGE:
    #
    # - Small space left of 0°
    # - X-axis ends at 6°
    # - Experiment legend
    # - Gaussian fit legend
    # - No grid
    ...
    # X-AXIS
    #
    # The small negative value gives space to the LEFT of 0°,
    # just like your attached graph.
    # --------------------------------------------------------
    ...
    ax.set_title(
        "Scattering Angle Distribution (E = 110 MeV/n)",
        fontsize=22,
        pad=14
    )
    ...
    if (
        ...
        and sigma_meas_deg > sigma_instr_deg
    ):
...
plt.title(
    "Experimental μ vs. Highland vs. Lynch–Dahl (Al foil)",
    fontsize=14
)
